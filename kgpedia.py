...
class KGPediaModel:
    ...
    def get_fusion_retriever(self, chat_profile, similarity_top_k=8):
        ...
        fusionretriever = QueryFusionRetriever([vector_retriever, bm25_retriever],similarity_top_k=5,num_queries=3,mode="reciprocal_rerank",use_async=False,verbose=True)
